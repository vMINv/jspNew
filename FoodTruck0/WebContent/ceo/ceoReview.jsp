            ...
            $.ajax({
                ...
                success:function(data) {
                    ...
                    for (var i = 0; i < reviews.length; i++) {
                        ...
                        str += "<div><i class='fa fa-quote-left fa-2x text-primary me-5'></i>" + reviews[i].rcontent + "<i class='fa fa-quote-right fa-2x text-primary ms-5'></i></div></div>";
                    }
...
<body>
    ...
    <div class="container-xxl py-5 bg-dark hero-header mb-5">
        <div class="container text-center my-5 pt-5 pb-4">
            <h1 class="display-3 text-white mb-3 animated slideInDown">내 푸드 트럭 리뷰 목록</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center text-uppercase">
                    <li class="breadcrumb-item"><a href="/main.jsp">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Settings</a></li>
                    <li class="breadcrumb-item"><a href="/ceo/ceoFoodList.jsp">푸드 트럭 목록</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">내 푸드 트럭 리뷰 목록</li>
                </ol>
            </nav>
        </div>
    </div>
