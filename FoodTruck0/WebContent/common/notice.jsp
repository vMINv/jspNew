...
<body>
    ...
    <div class="container-xxl py-5 px-5 wow fadeInUp" data-wow-delay="0.1s">
        ...
        %>
        <div class="btn btn-primary text-light" style="float: right" onclick="location.href='/admin/notiUpdate.jsp'">공지 등록</div>
        <%
            }
        %>
        <nav aria-label="...">
                    ...
                    success:function(data){
                        ...
                        for(var i = 0; i < notices.length; i++){
                            ...
                            <%
                                if (userDAO.perCheck(sid) == 2) {
                            %>
                            str += "<a href='/admin/notiDel.jsp?nno=" + notices[i].nno + "'>" + notices[i].ntitle + "</a></div>"
                            <%
                                } else {
                            %>
                            str += "<a href='/common/notiInfo.jsp?nno=" + notices[i].nno + "'>" + notices[i].ntitle + "</a></div>"
                            <%
                                }
                            %>
