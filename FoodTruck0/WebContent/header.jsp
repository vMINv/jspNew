...
<div class="container-xxl bg-white p-0">
	...
	<div class="container-xxl position-relative p-0">
		<nav
			...
			<a href="/main.jsp" class="navbar-brand p-0">
				...
				<div class="navbar-nav ms-auto py-0 pe-4">
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu m-0 dropdown-first">
							<a href="/user/foodtruckmain.jsp" class="dropdown-item">푸드트럭목록</a> <a
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu m-0 dropdown-first">
							<!-- per : user -->
							<a href="/common/myOrderList.jsp" class="dropdown-item">주문목록</a> <a
								href="/common/myReviewList.jsp" class="dropdown-item">리뷰목록</a>
						</div>
					</div>
					<%
					}
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu m-0 dropdown-first">
							<a href="/common/myInfo.jsp" class="dropdown-item">프로필</a> 
							<!-- per : ceo -->
							<%
							if (userDAO.perCheck(sid) == 1) {
							%>
							<a href="/ceo/foodAdd.jsp" class="dropdown-item">푸드트럭등록</a> <a
								href="/ceo/ceoFoodList.jsp" class="dropdown-item">푸드트럭설정</a>
							<%
							} else if (userDAO.perCheck(sid) == 2) {
							%>
							<a href="/admin/userList.jsp?page=1" class="dropdown-item">회원관리</a>
							<li class="dropdown-submenu">
								<div class="dropend">
									<a class="dropdown-item dropdown-toggle" href="#">푸드트럭관리</a>
								</div>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="/admin/foodProcess.jsp">푸드트럭승인</a></li>
									<li><a class="dropdown-item" href="/admin/foodList.jsp">푸드트럭목록</a></li>
								</ul>
							</li> <a href="/common/notice.jsp?page=1" class="dropdown-item">공지사항관리</a>
							<%
							}
							%>
						</div>
