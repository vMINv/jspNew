			...
			<div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                   ...
                   <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">FOODTRUCK</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">푸드트럭 목록</li>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <button onclick="location.href='/user/login.jsp'" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		      </div>
 			...
 			success:function(data){
 				...
 				if(loc[i].fpro == 1){
 					...
 					if(loc[i].fphoto != null && loc[i].fphoto != ""){
 						str += "<tr onclick='detailInfo("+loc[i].fno+")'><td><div><img src='../img/" + loc[i].fphoto +"'width='200' height='100'></div></td>";
 					}
