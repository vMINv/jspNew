		 ...
		 <div class="container">
			 <form id="requestForm" action="notiEdit.jsp" method="post">
				 ...
				 <div class="row mb-3">
					 ...
					 <div class="col-sm-10">
						 <input type="text" id="title" name="ntitle" class="form-control" placeholder="<%=noti.getNtitle()%>">
					 </div>
				 </div>
				 <div class="row mb-3">
					 <strong  class="col-sm-2 col-form-label">
				 ...
				 <div class="d-grid gap-2">
					 ...
					 <button type="button" class="btn btn-primary" onclick="location.href=goBack();">취소</button>
				 </div>
			 </form>
		 </div>
	 </div>
