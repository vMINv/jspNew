...
<%
	...
	String uploadPath = "/Users/shimhyunmin/develop/jspNew/FoodTruck_Web0203/WebContent/img"; //개인마다 WebContent 아래에 img 폴더 경로로 지정해야 함
	...
	fmenu 	  = Arrays.toString(multipartRequest.getParameterValues("fmenu")).trim();
	fprice 	  = Arrays.toString(multipartRequest.getParameterValues("fprice")).trim();
