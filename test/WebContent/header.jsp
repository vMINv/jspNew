        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fa fa-utensils me-3"></i>FoodTruck</h1>
                    ...
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="#" class="dropdown-item">가게목록</a>
                                <a href="/food/info.jsp" class="dropdown-item">제보하기</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="#" class="dropdown-item">문의사항</a>
                            </div>
                        </div>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="#" class="dropdown-item">내주문</a>
                                <a href="#" class="dropdown-item">내리뷰목록</a>
                                <!-- per : ceo -->
								<%} else {%>
                                <a href="#" class="dropdown-item">주문내역</a>
                                <a href="#" class="dropdown-item">내가게리뷰목록</a>
                        		<%} %>
                            </div>
                        </div>
                        <%} %>
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="#" class="dropdown-item">가게등록</a>
                                <a href="#" class="dropdown-item">가게상세보기</a>
                                <%} else if (userDAO.perCheck(sid)==2) {%>
                                <a href="#" class="dropdown-item">회원관리</a>
                                <a class="dropdown-item dropdown-toggle">푸드 트럭 관리</a>
                                <div class="dropdown-menu m-0">
	                                <a href="#" class="dropdown-item">가게승인</a>
	                                <a href="#" class="dropdown-item">가게목록</a>
                                </div>
                                <a href="#" class="dropdown-item">공지사항관리</a>
                                <a href="#" class="dropdown-item">리뷰관리</a>
                                <%} %>
                            </div>
                        </div>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="#" class="dropdown-item">Sign</a>
                            </div>
                        </div>
                        <%} %>
                    </div>
