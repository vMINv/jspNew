		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        <button onclick="location.href='/user/main.jsp'" class="btn btn-primary">메인페이지</button>
		      </div>
		    </div>
		  </div>
		</div>
	...
	<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        <button onclick="location.href='/user/signout.jsp'" class="btn btn-primary">탈퇴</button>
	      </div>
	    </div>
	  </div>
	</div>
