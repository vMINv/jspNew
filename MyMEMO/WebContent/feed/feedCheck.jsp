	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        <button onclick="location.href='/user/main.jsp'" class="btn btn-primary">메모 목록</button>
	      </div>
	    </div>
	  </div>
	</div>
	...
	<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        <button onclick="location.href='/feed/feedadd.jsp'" class="btn btn-primary">메모 작성</button>
	      </div>
	    </div>
	  </div>
	</div>
