           ...
           <div class="col-12">
            ...
            <div class="col-8 addInput" >
              ...
              <div class="input-group has-validation">
                ...
                <input type="number" class="form-control" name="fprice" id="fprice" step="500" min="0" placeholder="가격" required>
...
<script>
	function add(){
		...
		tmp += '<input type="number" class="form-control" name="fprice" id="fprice" step="500" min="0" placeholder="가격">';
