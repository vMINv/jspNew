				...
				<div class="navbar-nav ms-auto py-0 pe-4">
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu m-0 dropdown-first">
							<a href="booking.html" class="dropdown-item">푸드트럭목록</a> <a
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu m-0 dropdown-first">
							...
							%>
							<a href="/ceo/ceoFoodList.jsp" class="dropdown-item">내 푸드트럭</a>
							<%
							}
							%>
						</div>
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu m-0 dropdown-first">
							...
							<a href="/ceo/foodAdd.jsp" class="dropdown-item">푸드트럭등록</a> <a
								href="/ceo/foodListCeo.jsp" class="dropdown-item">푸드트럭설정</a>
							<%
