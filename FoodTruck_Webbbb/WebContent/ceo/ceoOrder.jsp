            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    for(var i = 0; i < orders.length; i++){
                        ...
                        if (orders[i].opro == 0) {
                            str += "<div class='col-3 themed-grid-col text-danger' onclick='detailOrder(" + orders[i].ono +")'>진행중</div>";
                        } else {
                            str += "<div class='col-3 themed-grid-col text-success' onclick='detailOrder(" + orders[i].ono +")'>완료</div>";
                        }
