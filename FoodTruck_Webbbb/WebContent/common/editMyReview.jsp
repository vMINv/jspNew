...
<!-- 리뷰등록 -->
<form action="editMyReviewProc.jsp" method="POST">
<div class="container">
	...
	<div class="mb-3">
		<div class="row">
			<div class="col">
				<button type="submit" class="btn btn-primary w-100 py-3">등록하기</button>
			</div>
			<div class="col">
				<button type="reset" class="btn btn-primary w-100 py-3">취소하기</button>
			</div>
		</div>
	</div>
</div>
