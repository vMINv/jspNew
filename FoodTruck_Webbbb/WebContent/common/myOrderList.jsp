...
$.ajax({
    ...
    success: function (data) {
        ...
        for (var i = 0; i < orders.length; i++) {
            ...
            str += "<button type='button' style='float:right; background:red;' class='badge rounded-pill' data-bs-toggle='modal' data-bs-target='#exampleModal' onclick='delOrder(" + orders[i].ono + ")'>주문 취소</button>";
            str += "</ul>";
            str += "</div>";
            str += "</td>";
            str += "</tr>";
