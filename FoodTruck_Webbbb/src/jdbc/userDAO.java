...
public class userDAO {
   ...
   public static userDTO info(String id) throws NamingException, SQLException {
      ...
      try {
         ...
         String sql = "SELECT id, password, mail, name FROM user WHERE id=?";
   ...
   public static String userList(int page) throws SQLException {
	   String sql = "SELECT id, per, password, mail, name FROM user LIMIT ?, 10";
